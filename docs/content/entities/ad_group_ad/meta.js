    ...
    object: {
        ad: {
            ...
            type: {
                ...
                _enums: [
                    ...
                    {
                        s: 'VIDEO_NON_SKIPPABLE_IN_STREAM_AD',
                        description: 'Video non-skippable in-stream ad.',
                        index: 26,
                    },
        ...
        ad_strength: {
            ...
            _enums: [
                ...
                { s: 'PENDING', description: 'The ad strength is currently pending.', index: 2 },
                { s: 'NO_ADS', description: 'No ads could be generated.', index: 3 },
                { s: 'POOR', description: 'Poor strength.', index: 4 },
                { s: 'AVERAGE', description: 'Average strength.', index: 5 },
                { s: 'GOOD', description: 'Good strength.', index: 6 },
                { s: 'EXCELLENT', description: 'Excellent strength.', index: 7 },
            ],
            _type: 'enum',
        },
        policy_summary: {
        ...
        status: {
            ...
            _enums: [
                ...
                { s: 'ENABLED', description: 'The ad group ad is enabled.', index: 2 },
                { s: 'PAUSED', description: 'The ad group ad is paused.', index: 3 },
                { s: 'REMOVED', description: 'The ad group ad is removed.', index: 4 },
            ],
            _type: 'enum',
        },
    },
