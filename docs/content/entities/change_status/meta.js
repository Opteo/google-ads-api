    ...
    object: {
        ...
        resource_status: {
            ...
            _enums: [
                ...
                { s: 'ADDED', description: 'The resource was created.', index: 2 },
                { s: 'CHANGED', description: 'The resource was modified.', index: 3 },
                { s: 'REMOVED', description: 'The resource was removed.', index: 4 },
            ],
            _type: 'enum',
        },
        resource_type: {
            ...
            _enums: [
                ...
                { s: 'AD_GROUP', description: 'An AdGroup resource change.', index: 3 },
                { s: 'AD_GROUP_AD', description: 'An AdGroupAd resource change.', index: 4 },
                { s: 'AD_GROUP_CRITERION', description: 'An AdGroupCriterion resource change.', index: 5 },
                { s: 'CAMPAIGN', description: 'A Campaign resource change.', index: 6 },
                { s: 'CAMPAIGN_CRITERION', description: 'A CampaignCriterion resource change.', index: 7 },
                { s: 'FEED', description: 'A Feed resource change.', index: 9 },
                { s: 'FEED_ITEM', description: 'A FeedItem resource change.', index: 10 },
                { s: 'AD_GROUP_FEED', description: 'An AdGroupFeed resource change.', index: 11 },
                { s: 'CAMPAIGN_FEED', description: 'A CampaignFeed resource change.', index: 12 },
                { s: 'AD_GROUP_BID_MODIFIER', description: 'An AdGroupBidModifier resource change.', index: 13 },
            ],
            _type: 'enum',
        },
    },
