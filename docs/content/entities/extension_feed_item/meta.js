module.exports = {
    ...
    object: {
        structured_snippet_feed_item: {
            header: { _type: 'string', _description: 'The header of the snippet.\nThis string must not be empty.' },
            values: {
                _type: 'array',
                _description: 'The values in the snippet.\nThe maximum size of this collection is 10.',
            },
            _oneof: 'extension',
        },
        sitelink_feed_item: {
            ...
            final_url_suffix: {
                _type: 'string',
                _description: 'Final URL suffix to be appended to landing page URLs served with\nparallel tracking.',
            },
            _oneof: 'extension',
        },
        extension_type: {
            ...
            _description: 'The extension type of the extension feed item.\nThis field is read-only.',
        },
        callout_feed_item: {
            callout_text: {
                _type: 'string',
                _description: 'The callout text.\nThe length of this string should be between 1 and 25, inclusive.',
            },
            _oneof: 'extension',
        },
        call_feed_item: {
            ...
            phone_number: {
                _type: 'string',
                _description: "The advertiser's phone number to append to the ad.\nThis string must not be empty.",
            },
            ...
            call_tracking_enabled: {
                _type: 'boolean',
                _description: 'Indicates whether call tracking is enabled. By default, call tracking is\nnot enabled.',
            },
        ...
        status: {
            ...
            _description: 'Status of the feed item.\nThis field is read-only.',
        },
        start_date_time: {
            _type: 'string',
            _description:
        ...
        price_feed_item: {
            ...
            final_url_suffix: {
                _type: 'string',
                _description: 'URL template for appending params to landing page URLs served with parallel\ntracking.',
            },
        ...
        app_feed_item: {
            app_id: {
                _type: 'string',
                _description: 'The store-specific ID for the target application.\nThis string must not be empty.',
            },
            final_urls: {
                _type: 'array',
                _description: 'A list of possible final URLs after all cross domain redirects.',
        ...
        promotion_feed_item: {
            language_code: {
                _type: 'string',
                _description: 'The language of the promotion.\nRepresented as BCP 47 language tag.',
            },
            discount_modifier: {
                _type: 'enum',
                _enums: [
            ...
            promotion_target: {
                _type: 'string',
                _description: 'A freeform description of what the promotion is targeting.\nThis field is required.',
            },
        ...
        text_message_feed_item: {
            ...
            text: { _type: 'string', _description: 'The text to show in the ad.\nThis field is required.' },
            phone_number: {
                _type: 'string',
            ...
            business_name: {
                _type: 'string',
                _description: 'The business name to prepend to the message text.\nThis field is required.',
            },
            country_code: {
                _type: 'string',
                _description:
