module.exports = {
    ...
    object: {
        ...
        id: { _description: 'Output only. The ID of the keyword plan ad group.', _type: 'int64' },
        ...
        resource_name: {
            _description:
                'Immutable. The resource name of the Keyword Planner ad group. KeywordPlanAdGroup resource names have the form: <code>customers/{customer_id}/keywordPlanAdGroups/{kp_ad_group_id}</code>',
            _type: 'string',
        },
    },
