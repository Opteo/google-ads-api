module.exports = {
    ...
    object: {
        id: { _description: 'Output only. Id of the remarketing action.', _type: 'int64' },
        name: {
            _description:
        ...
        resource_name: {
            _description:
                'Immutable. The resource name of the remarketing action. Remarketing action resource names have the form: <code>customers/{customer_id}/remarketingActions/{remarketing_action_id}</code>',
            _type: 'string',
        },
        tag_snippets: {
            _parent_description: 'Output only. The snippets used for tracking remarketing actions.',
