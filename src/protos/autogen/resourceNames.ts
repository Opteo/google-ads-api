...
*/
export function campaignCriterionSimulation(customerId: string | number, campaignId: string | number, criterionId: string | number, type: string | number, modificationMethod: string | number, startDate: string | number, endDate: string | number): CampaignCriterionSimulationResourceName { return `customers/${customerId}/campaignCriterionSimulations/${campaignId}~${criterionId}~${type}~${modificationMethod}~${startDate}~${endDate}` as const }
...
*/
export function campaignExperiment(customerId: string | number, campaignExperimentId: string | number): CampaignExperimentResourceName { return `customers/${customerId}/campaignExperiments/${campaignExperimentId}` as const }
