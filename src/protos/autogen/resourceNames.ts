...
*/
export function accessibleBiddingStrategy(customerId: string | number, biddingStrategyId: string | number): AccessibleBiddingStrategyResourceName { return `customers/${customerId}/accessibleBiddingStrategies/${biddingStrategyId}` as const }
...
*/
export function accountBudgetProposal(customerId: string | number, accountBudgetProposalId: string | number): AccountBudgetProposalResourceName { return `customers/${customerId}/accountBudgetProposals/${accountBudgetProposalId}` as const }
...
*/
export function accountLink(customerId: string | number, accountLinkId: string | number): AccountLinkResourceName { return `customers/${customerId}/accountLinks/${accountLinkId}` as const }
...
*/
export function ad(customerId: string | number, adId: string | number): AdResourceName { return `customers/${customerId}/ads/${adId}` as const }
...
*/
export function adGroup(customerId: string | number, adGroupId: string | number): AdGroupResourceName { return `customers/${customerId}/adGroups/${adGroupId}` as const }
...
*/
export function adGroupAd(customerId: string | number, adGroupId: string | number, adId: string | number): AdGroupAdResourceName { return `customers/${customerId}/adGroupAds/${adGroupId}~${adId}` as const }
...
*/
export function adGroupAdAssetCombinationView(customerId: string | number, adGroupId: string | number, adId: string | number, assetCombinationIdLow: string | number, assetCombinationIdHigh: string | number): AdGroupAdAssetCombinationViewResourceName { return `customers/${customerId}/adGroupAdAssetCombinationViews/${adGroupId}~${adId}~${assetCombinationIdLow}~${assetCombinationIdHigh}` as const }
...
*/
export function adGroupAdAssetView(customerId: string | number, adGroupId: string | number, adId: string | number, assetId: string | number, fieldType: string | number): AdGroupAdAssetViewResourceName { return `customers/${customerId}/adGroupAdAssetViews/${adGroupId}~${adId}~${assetId}~${fieldType}` as const }
...
*/
export function adGroupAdLabel(customerId: string | number, adGroupId: string | number, adId: string | number, labelId: string | number): AdGroupAdLabelResourceName { return `customers/${customerId}/adGroupAdLabels/${adGroupId}~${adId}~${labelId}` as const }
...
*/
export function adGroupAsset(customerId: string | number, adGroupId: string | number, assetId: string | number, fieldType: string | number): AdGroupAssetResourceName { return `customers/${customerId}/adGroupAssets/${adGroupId}~${assetId}~${fieldType}` as const }
...
*/
export function adGroupAssetSet(customerId: string | number, adGroupId: string | number, assetSetId: string | number): AdGroupAssetSetResourceName { return `customers/${customerId}/adGroupAssetSets/${adGroupId}~${assetSetId}` as const }
...
*/
export function adGroupAudienceView(customerId: string | number, adGroupId: string | number, criterionId: string | number): AdGroupAudienceViewResourceName { return `customers/${customerId}/adGroupAudienceViews/${adGroupId}~${criterionId}` as const }
...
*/
export function adGroupBidModifier(customerId: string | number, adGroupId: string | number, criterionId: string | number): AdGroupBidModifierResourceName { return `customers/${customerId}/adGroupBidModifiers/${adGroupId}~${criterionId}` as const }
...
*/
export function adGroupCriterion(customerId: string | number, adGroupId: string | number, criterionId: string | number): AdGroupCriterionResourceName { return `customers/${customerId}/adGroupCriteria/${adGroupId}~${criterionId}` as const }
...
*/
export function adGroupCriterionCustomizer(customerId: string | number, adGroupId: string | number, criterionId: string | number, customizerAttributeId: string | number): AdGroupCriterionCustomizerResourceName { return `customers/${customerId}/adGroupCriterionCustomizers/${adGroupId}~${criterionId}~${customizerAttributeId}` as const }
...
*/
export function adGroupCriterionLabel(customerId: string | number, adGroupId: string | number, criterionId: string | number, labelId: string | number): AdGroupCriterionLabelResourceName { return `customers/${customerId}/adGroupCriterionLabels/${adGroupId}~${criterionId}~${labelId}` as const }
...
*/
export function adGroupCustomizer(customerId: string | number, adGroupId: string | number, customizerAttributeId: string | number): AdGroupCustomizerResourceName { return `customers/${customerId}/adGroupCustomizers/${adGroupId}~${customizerAttributeId}` as const }
...
*/
export function adGroupLabel(customerId: string | number, adGroupId: string | number, labelId: string | number): AdGroupLabelResourceName { return `customers/${customerId}/adGroupLabels/${adGroupId}~${labelId}` as const }
...
*/
export function adGroupSimulation(customerId: string | number, adGroupId: string | number, type: string | number, modificationMethod: string | number, startDate: string | number, endDate: string | number): AdGroupSimulationResourceName { return `customers/${customerId}/adGroupSimulations/${adGroupId}~${type}~${modificationMethod}~${startDate}~${endDate}` as const }
...
*/
export function adParameter(customerId: string | number, adGroupId: string | number, criterionId: string | number, parameterIndex: string | number): AdParameterResourceName { return `customers/${customerId}/adParameters/${adGroupId}~${criterionId}~${parameterIndex}` as const }
...
*/
export function adScheduleView(customerId: string | number, campaignId: string | number, criterionId: string | number): AdScheduleViewResourceName { return `customers/${customerId}/adScheduleViews/${campaignId}~${criterionId}` as const }
...
*/
export function ageRangeView(customerId: string | number, adGroupId: string | number, criterionId: string | number): AgeRangeViewResourceName { return `customers/${customerId}/ageRangeViews/${adGroupId}~${criterionId}` as const }
...
*/
export function aiMaxSearchTermAdCombinationView(customerId: string | number, adGroupId: string | number, searchTerm: string | number, landingPage: string | number, headline: string | number): AiMaxSearchTermAdCombinationViewResourceName { return `customers/${customerId}/aiMaxSearchTermAdCombinationViews/${adGroupId}~${searchTerm}~${landingPage}~${headline}` as const }
...
*/
export function androidPrivacySharedKeyGoogleAdGroup(customerId: string | number, campaignId: string | number, adGroupId: string | number, androidPrivacyInteractionType: string | number, androidPrivacyNetworkType: string | number, androidPrivacyInteractionDate: string | number): AndroidPrivacySharedKeyGoogleAdGroupResourceName { return `customers/${customerId}/androidPrivacySharedKeyGoogleAdGroups/${campaignId}~${adGroupId}~${androidPrivacyInteractionType}~${androidPrivacyNetworkType}~${androidPrivacyInteractionDate}` as const }
...
*/
export function androidPrivacySharedKeyGoogleCampaign(customerId: string | number, campaignId: string | number, androidPrivacyInteractionType: string | number, androidPrivacyInteractionDate: string | number): AndroidPrivacySharedKeyGoogleCampaignResourceName { return `customers/${customerId}/androidPrivacySharedKeyGoogleCampaigns/${campaignId}~${androidPrivacyInteractionType}~${androidPrivacyInteractionDate}` as const }
...
*/
export function androidPrivacySharedKeyGoogleNetworkType(customerId: string | number, campaignId: string | number, androidPrivacyInteractionType: string | number, androidPrivacyNetworkType: string | number, androidPrivacyInteractionDate: string | number): AndroidPrivacySharedKeyGoogleNetworkTypeResourceName { return `customers/${customerId}/androidPrivacySharedKeyGoogleNetworkTypes/${campaignId}~${androidPrivacyInteractionType}~${androidPrivacyNetworkType}~${androidPrivacyInteractionDate}` as const }
...
*/
export function appTopCombinationView(customerId: string | number, adGroupId: string | number, adId: string | number, assetCombinationCategory: string | number): AppTopCombinationViewResourceName { return `customers/${customerId}/appTopCombinationViews/${adGroupId}~${adId}~${assetCombinationCategory}` as const }
...
*/
export function appliedIncentive(customerId: string | number, couponCode: string | number): AppliedIncentiveResourceName { return `customers/${customerId}/appliedIncentives/${couponCode}` as const }
...
*/
export function asset(customerId: string | number, assetId: string | number): AssetResourceName { return `customers/${customerId}/assets/${assetId}` as const }
...
*/
export function assetFieldTypeView(customerId: string | number, fieldType: string | number): AssetFieldTypeViewResourceName { return `customers/${customerId}/assetFieldTypeViews/${fieldType}` as const }
...
*/
export function assetGroup(customerId: string | number, assetGroupId: string | number): AssetGroupResourceName { return `customers/${customerId}/assetGroups/${assetGroupId}` as const }
...
*/
export function assetGroupAsset(customerId: string | number, assetGroupId: string | number, assetId: string | number, fieldType: string | number): AssetGroupAssetResourceName { return `customers/${customerId}/assetGroupAssets/${assetGroupId}~${assetId}~${fieldType}` as const }
...
*/
export function assetGroupListingGroupFilter(customerId: string | number, assetGroupId: string | number, listingGroupFilterId: string | number): AssetGroupListingGroupFilterResourceName { return `customers/${customerId}/assetGroupListingGroupFilters/${assetGroupId}~${listingGroupFilterId}` as const }
...
*/
export function assetGroupProductGroupView(customerId: string | number, assetGroupId: string | number, listingGroupFilterId: string | number): AssetGroupProductGroupViewResourceName { return `customers/${customerId}/assetGroupProductGroupViews/${assetGroupId}~${listingGroupFilterId}` as const }
...
*/
export function assetGroupSignal(customerId: string | number, assetGroupId: string | number, criterionId: string | number): AssetGroupSignalResourceName { return `customers/${customerId}/assetGroupSignals/${assetGroupId}~${criterionId}` as const }
...
*/
export function assetGroupTopCombinationView(customerId: string | number, assetGroupId: string | number, assetCombinationCategory: string | number): AssetGroupTopCombinationViewResourceName { return `customers/${customerId}/assetGroupTopCombinationViews/${assetGroupId}~${assetCombinationCategory}` as const }
...
*/
export function assetSet(customerId: string | number, assetSetId: string | number): AssetSetResourceName { return `customers/${customerId}/assetSets/${assetSetId}` as const }
...
*/
export function assetSetAsset(customerId: string | number, assetSetId: string | number, assetId: string | number): AssetSetAssetResourceName { return `customers/${customerId}/assetSetAssets/${assetSetId}~${assetId}` as const }
...
*/
export function assetSetTypeView(customerId: string | number, assetSetType: string | number): AssetSetTypeViewResourceName { return `customers/${customerId}/assetSetTypeViews/${assetSetType}` as const }
...
*/
export function audience(customerId: string | number, audienceId: string | number): AudienceResourceName { return `customers/${customerId}/audiences/${audienceId}` as const }
...
*/
export function batchJob(customerId: string | number, batchJobId: string | number): BatchJobResourceName { return `customers/${customerId}/batchJobs/${batchJobId}` as const }
...
*/
export function biddingDataExclusion(customerId: string | number, seasonalityEventId: string | number): BiddingDataExclusionResourceName { return `customers/${customerId}/biddingDataExclusions/${seasonalityEventId}` as const }
...
*/
export function biddingSeasonalityAdjustment(customerId: string | number, seasonalityEventId: string | number): BiddingSeasonalityAdjustmentResourceName { return `customers/${customerId}/biddingSeasonalityAdjustments/${seasonalityEventId}` as const }
...
*/
export function biddingStrategy(customerId: string | number, biddingStrategyId: string | number): BiddingStrategyResourceName { return `customers/${customerId}/biddingStrategies/${biddingStrategyId}` as const }
...
*/
export function biddingStrategySimulation(customerId: string | number, biddingStrategyId: string | number, type: string | number, modificationMethod: string | number, startDate: string | number, endDate: string | number): BiddingStrategySimulationResourceName { return `customers/${customerId}/biddingStrategySimulations/${biddingStrategyId}~${type}~${modificationMethod}~${startDate}~${endDate}` as const }
...
*/
export function billingSetup(customerId: string | number, billingSetupId: string | number): BillingSetupResourceName { return `customers/${customerId}/billingSetups/${billingSetupId}` as const }
...
*/
export function callView(customerId: string | number, callDetailId: string | number): CallViewResourceName { return `customers/${customerId}/callViews/${callDetailId}` as const }
...
*/
export function campaign(customerId: string | number, campaignId: string | number): CampaignResourceName { return `customers/${customerId}/campaigns/${campaignId}` as const }
...
*/
export function campaignAggregateAssetView(customerId: string | number, campaignId: string | number, assetId: string | number, assetLinkSource: string | number, fieldType: string | number): CampaignAggregateAssetViewResourceName { return `customers/${customerId}/campaignAggregateAssetViews/${campaignId}~${assetId}~${assetLinkSource}~${fieldType}` as const }
...
*/
export function campaignAsset(customerId: string | number, campaignId: string | number, assetId: string | number, fieldType: string | number): CampaignAssetResourceName { return `customers/${customerId}/campaignAssets/${campaignId}~${assetId}~${fieldType}` as const }
...
*/
export function campaignAssetSet(customerId: string | number, campaignId: string | number, assetSetId: string | number): CampaignAssetSetResourceName { return `customers/${customerId}/campaignAssetSets/${campaignId}~${assetSetId}` as const }
...
*/
export function campaignAudienceView(customerId: string | number, campaignId: string | number, criterionId: string | number): CampaignAudienceViewResourceName { return `customers/${customerId}/campaignAudienceViews/${campaignId}~${criterionId}` as const }
...
*/
export function campaignBidModifier(customerId: string | number, campaignId: string | number, criterionId: string | number): CampaignBidModifierResourceName { return `customers/${customerId}/campaignBidModifiers/${campaignId}~${criterionId}` as const }
...
*/
export function campaignBudget(customerId: string | number, campaignBudgetId: string | number): CampaignBudgetResourceName { return `customers/${customerId}/campaignBudgets/${campaignBudgetId}` as const }
...
*/
export function campaignConversionGoal(customerId: string | number, campaignId: string | number, category: string | number, source: string | number): CampaignConversionGoalResourceName { return `customers/${customerId}/campaignConversionGoals/${campaignId}~${category}~${source}` as const }
...
*/
export function campaignCriterion(customerId: string | number, campaignId: string | number, criterionId: string | number): CampaignCriterionResourceName { return `customers/${customerId}/campaignCriteria/${campaignId}~${criterionId}` as const }
...
*/
export function campaignCustomizer(customerId: string | number, campaignId: string | number, customizerAttributeId: string | number): CampaignCustomizerResourceName { return `customers/${customerId}/campaignCustomizers/${campaignId}~${customizerAttributeId}` as const }
...
*/
export function campaignDraft(customerId: string | number, baseCampaignId: string | number, draftId: string | number): CampaignDraftResourceName { return `customers/${customerId}/campaignDrafts/${baseCampaignId}~${draftId}` as const }
...
*/
export function campaignGoalConfig(customerId: string | number, campaignId: string | number, unifiedGoalId: string | number): CampaignGoalConfigResourceName { return `customers/${customerId}/campaignGoalConfigs/${campaignId}~${unifiedGoalId}` as const }
...
*/
export function campaignGroup(customerId: string | number, campaignGroupId: string | number): CampaignGroupResourceName { return `customers/${customerId}/campaignGroups/${campaignGroupId}` as const }
...
*/
export function campaignLabel(customerId: string | number, campaignId: string | number, labelId: string | number): CampaignLabelResourceName { return `customers/${customerId}/campaignLabels/${campaignId}~${labelId}` as const }
...
*/
export function campaignSearchTermInsight(customerId: string | number, campaignId: string | number, clusterId: string | number): CampaignSearchTermInsightResourceName { return `customers/${customerId}/campaignSearchTermInsights/${campaignId}~${clusterId}` as const }
...
*/
export function campaignSearchTermView(customerId: string | number, campaignId: string | number, query: string | number): CampaignSearchTermViewResourceName { return `customers/${customerId}/campaignSearchTermViews/${campaignId}~${query}` as const }
...
*/
export function campaignSharedSet(customerId: string | number, campaignId: string | number, sharedSetId: string | number): CampaignSharedSetResourceName { return `customers/${customerId}/campaignSharedSets/${campaignId}~${sharedSetId}` as const }
...
*/
export function campaignSimulation(customerId: string | number, campaignId: string | number, type: string | number, modificationMethod: string | number, startDate: string | number, endDate: string | number): CampaignSimulationResourceName { return `customers/${customerId}/campaignSimulations/${campaignId}~${type}~${modificationMethod}~${startDate}~${endDate}` as const }
...
*/
export function cartDataSalesView(customerId: string | number): CartDataSalesViewResourceName { return `customers/${customerId}/cartDataSalesView` as const }
...
*/
export function changeEvent(customerId: string | number, timestampMicros: string | number, commandIndex: string | number, mutateIndex: string | number): ChangeEventResourceName { return `customers/${customerId}/changeEvents/${timestampMicros}~${commandIndex}~${mutateIndex}` as const }
...
*/
export function changeStatus(customerId: string | number, changeStatusId: string | number): ChangeStatusResourceName { return `customers/${customerId}/changeStatus/${changeStatusId}` as const }
...
*/
export function channelAggregateAssetView(customerId: string | number, advertisingChannelType: string | number, assetId: string | number, assetSource: string | number, fieldType: string | number): ChannelAggregateAssetViewResourceName { return `customers/${customerId}/channelAggregateAssetViews/${advertisingChannelType}~${assetId}~${assetSource}~${fieldType}` as const }
...
*/
export function clickView(customerId: string | number, date: string | number, gclid: string | number): ClickViewResourceName { return `customers/${customerId}/clickViews/${date}~${gclid}` as const }
...
*/
export function combinedAudience(customerId: string | number, combinedAudienceId: string | number): CombinedAudienceResourceName { return `customers/${customerId}/combinedAudiences/${combinedAudienceId}` as const }
...
*/
export function contentCriterionView(customerId: string | number, adGroupId: string | number, criterionId: string | number): ContentCriterionViewResourceName { return `customers/${customerId}/contentCriterionViews/${adGroupId}~${criterionId}` as const }
...
*/
export function conversionAction(customerId: string | number, conversionActionId: string | number): ConversionActionResourceName { return `customers/${customerId}/conversionActions/${conversionActionId}` as const }
...
*/
export function conversionCustomVariable(customerId: string | number, conversionCustomVariableId: string | number): ConversionCustomVariableResourceName { return `customers/${customerId}/conversionCustomVariables/${conversionCustomVariableId}` as const }
...
*/
export function conversionGoalCampaignConfig(customerId: string | number, campaignId: string | number): ConversionGoalCampaignConfigResourceName { return `customers/${customerId}/conversionGoalCampaignConfigs/${campaignId}` as const }
...
*/
export function conversionValueRule(customerId: string | number, conversionValueRuleId: string | number): ConversionValueRuleResourceName { return `customers/${customerId}/conversionValueRules/${conversionValueRuleId}` as const }
...
*/
export function conversionValueRuleSet(customerId: string | number, conversionValueRuleSetId: string | number): ConversionValueRuleSetResourceName { return `customers/${customerId}/conversionValueRuleSets/${conversionValueRuleSetId}` as const }
...
*/
export function currencyConstant(code: string | number): CurrencyConstantResourceName { return `currencyConstants/${code}` as const }
...
*/
export function customAudience(customerId: string | number, customAudienceId: string | number): CustomAudienceResourceName { return `customers/${customerId}/customAudiences/${customAudienceId}` as const }
...
*/
export function customConversionGoal(customerId: string | number, goalId: string | number): CustomConversionGoalResourceName { return `customers/${customerId}/customConversionGoals/${goalId}` as const }
...
*/
export function customInterest(customerId: string | number, customInterestId: string | number): CustomInterestResourceName { return `customers/${customerId}/customInterests/${customInterestId}` as const }
...
*/
export function customer(customerId: string | number): CustomerResourceName { return `customers/${customerId}` as const }
...
*/
export function customerAsset(customerId: string | number, assetId: string | number, fieldType: string | number): CustomerAssetResourceName { return `customers/${customerId}/customerAssets/${assetId}~${fieldType}` as const }
...
*/
export function customerAssetSet(customerId: string | number, assetSetId: string | number): CustomerAssetSetResourceName { return `customers/${customerId}/customerAssetSets/${assetSetId}` as const }
...
*/
export function customerClient(customerId: string | number, clientCustomerId: string | number): CustomerClientResourceName { return `customers/${customerId}/customerClients/${clientCustomerId}` as const }
...
*/
export function customerClientLink(customerId: string | number, clientCustomerId: string | number, managerLinkId: string | number): CustomerClientLinkResourceName { return `customers/${customerId}/customerClientLinks/${clientCustomerId}~${managerLinkId}` as const }
...
*/
export function customerConversionGoal(customerId: string | number, category: string | number, source: string | number): CustomerConversionGoalResourceName { return `customers/${customerId}/customerConversionGoals/${category}~${source}` as const }
...
*/
export function customerCustomizer(customerId: string | number, customizerAttributeId: string | number): CustomerCustomizerResourceName { return `customers/${customerId}/customerCustomizers/${customizerAttributeId}` as const }
...
*/
export function customerLabel(customerId: string | number, labelId: string | number): CustomerLabelResourceName { return `customers/${customerId}/customerLabels/${labelId}` as const }
...
*/
export function customerManagerLink(customerId: string | number, managerCustomerId: string | number, managerLinkId: string | number): CustomerManagerLinkResourceName { return `customers/${customerId}/customerManagerLinks/${managerCustomerId}~${managerLinkId}` as const }
...
*/
export function customerNegativeCriterion(customerId: string | number, criterionId: string | number): CustomerNegativeCriterionResourceName { return `customers/${customerId}/customerNegativeCriteria/${criterionId}` as const }
...
*/
export function customerSearchTermInsight(customerId: string | number, clusterId: string | number): CustomerSearchTermInsightResourceName { return `customers/${customerId}/customerSearchTermInsights/${clusterId}` as const }
...
*/
export function customerSkAdNetworkConversionValueSchema(customerId: string | number, accountLinkId: string | number): CustomerSkAdNetworkConversionValueSchemaResourceName { return `customers/${customerId}/customerSkAdNetworkConversionValueSchemas/${accountLinkId}` as const }
...
*/
export function customerUserAccess(customerId: string | number, userId: string | number): CustomerUserAccessResourceName { return `customers/${customerId}/customerUserAccesses/${userId}` as const }
...
*/
export function customerUserAccessInvitation(customerId: string | number, invitationId: string | number): CustomerUserAccessInvitationResourceName { return `customers/${customerId}/customerUserAccessInvitations/${invitationId}` as const }
...
*/
export function customizerAttribute(customerId: string | number, customizerAttributeId: string | number): CustomizerAttributeResourceName { return `customers/${customerId}/customizerAttributes/${customizerAttributeId}` as const }
...
*/
export function dataLink(customerId: string | number, productLinkId: string | number, dataLinkId: string | number): DataLinkResourceName { return `customers/${customerId}/dataLinks/${productLinkId}~${dataLinkId}` as const }
...
*/
export function detailContentSuitabilityPlacementView(customerId: string | number, placementFingerprint: string | number): DetailContentSuitabilityPlacementViewResourceName { return `customers/${customerId}/detailContentSuitabilityPlacementViews/${placementFingerprint}` as const }
...
*/
export function detailPlacementView(customerId: string | number, adGroupId: string | number, base64Placement: string | number): DetailPlacementViewResourceName { return `customers/${customerId}/detailPlacementViews/${adGroupId}~${base64Placement}` as const }
...
*/
export function detailedDemographic(customerId: string | number, detailedDemographicId: string | number): DetailedDemographicResourceName { return `customers/${customerId}/detailedDemographics/${detailedDemographicId}` as const }
...
*/
export function displayKeywordView(customerId: string | number, adGroupId: string | number, criterionId: string | number): DisplayKeywordViewResourceName { return `customers/${customerId}/displayKeywordViews/${adGroupId}~${criterionId}` as const }
...
*/
export function distanceView(customerId: string | number, placeholderChainId: string | number, distanceBucket: string | number): DistanceViewResourceName { return `customers/${customerId}/distanceViews/${placeholderChainId}~${distanceBucket}` as const }
...
*/
export function domainCategory(customerId: string | number, campaignId: string | number, base64Category: string | number, languageCode: string | number): DomainCategoryResourceName { return `customers/${customerId}/domainCategories/${campaignId}~${base64Category}~${languageCode}` as const }
...
*/
export function dynamicSearchAdsSearchTermView(customerId: string | number, adGroupId: string | number, searchTermFingerprint: string | number, headlineFingerprint: string | number, landingPageFingerprint: string | number, pageUrlFingerprint: string | number): DynamicSearchAdsSearchTermViewResourceName { return `customers/${customerId}/dynamicSearchAdsSearchTermViews/${adGroupId}~${searchTermFingerprint}~${headlineFingerprint}~${landingPageFingerprint}~${pageUrlFingerprint}` as const }
...
*/
export function expandedLandingPageView(customerId: string | number, expandedFinalUrlFingerprint: string | number): ExpandedLandingPageViewResourceName { return `customers/${customerId}/expandedLandingPageViews/${expandedFinalUrlFingerprint}` as const }
...
*/
export function experiment(customerId: string | number, trialId: string | number): ExperimentResourceName { return `customers/${customerId}/experiments/${trialId}` as const }
...
*/
export function experimentArm(customerId: string | number, trialId: string | number, trialArmId: string | number): ExperimentArmResourceName { return `customers/${customerId}/experimentArms/${trialId}~${trialArmId}` as const }
...
*/
export function finalUrlExpansionAssetView(customerId: string | number, campaignId: string | number, assetId: string | number, fieldType: string | number, urlFp: string | number): FinalUrlExpansionAssetViewResourceName { return `customers/${customerId}/finalUrlExpansionAssetViews/${campaignId}~${assetId}~${fieldType}~${urlFp}` as const }
...
*/
export function genderView(customerId: string | number, adGroupId: string | number, criterionId: string | number): GenderViewResourceName { return `customers/${customerId}/genderViews/${adGroupId}~${criterionId}` as const }
...
*/
export function geoTargetConstant(criterionId: string | number): GeoTargetConstantResourceName { return `geoTargetConstants/${criterionId}` as const }
...
*/
export function geographicView(customerId: string | number, countryCriterionId: string | number, locationType: string | number): GeographicViewResourceName { return `customers/${customerId}/geographicViews/${countryCriterionId}~${locationType}` as const }
...
*/
export function goal(customerId: string | number, unifiedGoalId: string | number): GoalResourceName { return `customers/${customerId}/goals/${unifiedGoalId}` as const }
...
*/
export function googleAdsField(googleAdsField: string | number): GoogleAdsFieldResourceName { return `googleAdsFields/${googleAdsField}` as const }
...
*/
export function groupContentSuitabilityPlacementView(customerId: string | number, placementFingerprint: string | number): GroupContentSuitabilityPlacementViewResourceName { return `customers/${customerId}/groupContentSuitabilityPlacementViews/${placementFingerprint}` as const }
...
*/
export function groupPlacementView(customerId: string | number, adGroupId: string | number, base64Placement: string | number): GroupPlacementViewResourceName { return `customers/${customerId}/groupPlacementViews/${adGroupId}~${base64Placement}` as const }
...
*/
export function hotelGroupView(customerId: string | number, adGroupId: string | number, criterionId: string | number): HotelGroupViewResourceName { return `customers/${customerId}/hotelGroupViews/${adGroupId}~${criterionId}` as const }
...
*/
export function hotelReconciliation(customerId: string | number, commissionId: string | number): HotelReconciliationResourceName { return `customers/${customerId}/hotelReconciliations/${commissionId}` as const }
...
*/
export function incomeRangeView(customerId: string | number, adGroupId: string | number, criterionId: string | number): IncomeRangeViewResourceName { return `customers/${customerId}/incomeRangeViews/${adGroupId}~${criterionId}` as const }
...
*/
export function invoice(customerId: string | number, invoiceId: string | number): InvoiceResourceName { return `customers/${customerId}/invoices/${invoiceId}` as const }
...
*/
export function keywordPlan(customerId: string | number, keywordPlanId: string | number): KeywordPlanResourceName { return `customers/${customerId}/keywordPlans/${keywordPlanId}` as const }
...
*/
export function keywordPlanAdGroup(customerId: string | number, keywordPlanAdGroupId: string | number): KeywordPlanAdGroupResourceName { return `customers/${customerId}/keywordPlanAdGroups/${keywordPlanAdGroupId}` as const }
...
*/
export function keywordPlanAdGroupKeyword(customerId: string | number, keywordPlanAdGroupKeywordId: string | number): KeywordPlanAdGroupKeywordResourceName { return `customers/${customerId}/keywordPlanAdGroupKeywords/${keywordPlanAdGroupKeywordId}` as const }
...
*/
export function keywordPlanCampaign(customerId: string | number, keywordPlanCampaignId: string | number): KeywordPlanCampaignResourceName { return `customers/${customerId}/keywordPlanCampaigns/${keywordPlanCampaignId}` as const }
...
*/
export function keywordPlanCampaignKeyword(customerId: string | number, keywordPlanCampaignKeywordId: string | number): KeywordPlanCampaignKeywordResourceName { return `customers/${customerId}/keywordPlanCampaignKeywords/${keywordPlanCampaignKeywordId}` as const }
...
*/
export function keywordThemeConstant(expressCategoryId: string | number, expressSubCategoryId: string | number): KeywordThemeConstantResourceName { return `keywordThemeConstants/${expressCategoryId}~${expressSubCategoryId}` as const }
...
*/
export function keywordView(customerId: string | number, adGroupId: string | number, criterionId: string | number): KeywordViewResourceName { return `customers/${customerId}/keywordViews/${adGroupId}~${criterionId}` as const }
...
*/
export function label(customerId: string | number, labelId: string | number): LabelResourceName { return `customers/${customerId}/labels/${labelId}` as const }
...
*/
export function landingPageView(customerId: string | number, unexpandedFinalUrlFingerprint: string | number): LandingPageViewResourceName { return `customers/${customerId}/landingPageViews/${unexpandedFinalUrlFingerprint}` as const }
...
*/
export function languageConstant(criterionId: string | number): LanguageConstantResourceName { return `languageConstants/${criterionId}` as const }
...
*/
export function leadFormSubmissionData(customerId: string | number, leadFormUserSubmissionId: string | number): LeadFormSubmissionDataResourceName { return `customers/${customerId}/leadFormSubmissionData/${leadFormUserSubmissionId}` as const }
...
*/
export function lifeEvent(customerId: string | number, lifeEventId: string | number): LifeEventResourceName { return `customers/${customerId}/lifeEvents/${lifeEventId}` as const }
...
*/
export function liftMeasurementAgeRange(customerId: string | number, liftMeasurementConfigurationId: string | number, campaignId: string | number, criterionId: string | number): LiftMeasurementAgeRangeResourceName { return `customers/${customerId}/liftMeasurementAgeRanges/${liftMeasurementConfigurationId}~${campaignId}~${criterionId}` as const }
...
*/
export function liftMeasurementCampaign(customerId: string | number, liftMeasurementConfigurationId: string | number, campaignId: string | number): LiftMeasurementCampaignResourceName { return `customers/${customerId}/liftMeasurementCampaigns/${liftMeasurementConfigurationId}~${campaignId}` as const }
...
*/
export function liftMeasurementConfig(customerId: string | number, liftMeasurementConfigurationId: string | number): LiftMeasurementConfigResourceName { return `customers/${customerId}/liftMeasurementConfigs/${liftMeasurementConfigurationId}` as const }
...
*/
export function liftMeasurementDevice(customerId: string | number, liftMeasurementConfigurationId: string | number, campaignId: string | number, criterionId: string | number): LiftMeasurementDeviceResourceName { return `customers/${customerId}/liftMeasurementDevices/${liftMeasurementConfigurationId}~${campaignId}~${criterionId}` as const }
...
*/
export function liftMeasurementFlight(customerId: string | number, liftMeasurementConfigurationId: string | number, liftMeasurementFlightId: string | number): LiftMeasurementFlightResourceName { return `customers/${customerId}/liftMeasurementFlights/${liftMeasurementConfigurationId}~${liftMeasurementFlightId}` as const }
...
*/
export function liftMeasurementGender(customerId: string | number, liftMeasurementConfigurationId: string | number, campaignId: string | number, criterionId: string | number): LiftMeasurementGenderResourceName { return `customers/${customerId}/liftMeasurementGenders/${liftMeasurementConfigurationId}~${campaignId}~${criterionId}` as const }
...
*/
export function liftMeasurementVideo(customerId: string | number, liftMeasurementConfigurationId: string | number, campaignId: string | number, externalVideoId: string | number): LiftMeasurementVideoResourceName { return `customers/${customerId}/liftMeasurementVideos/${liftMeasurementConfigurationId}~${campaignId}~${externalVideoId}` as const }
...
*/
export function localServicesEmployee(customerId: string | number, glsEmployeeId: string | number): LocalServicesEmployeeResourceName { return `customers/${customerId}/localServicesEmployees/${glsEmployeeId}` as const }
...
*/
export function localServicesLead(customerId: string | number, localServicesLeadId: string | number): LocalServicesLeadResourceName { return `customers/${customerId}/localServicesLeads/${localServicesLeadId}` as const }
...
*/
export function localServicesLeadConversation(customerId: string | number, localServicesLeadConversationId: string | number): LocalServicesLeadConversationResourceName { return `customers/${customerId}/localServicesLeadConversations/${localServicesLeadConversationId}` as const }
...
*/
export function localServicesVerificationArtifact(customerId: string | number, glsVerificationArtifactId: string | number): LocalServicesVerificationArtifactResourceName { return `customers/${customerId}/localServicesVerificationArtifacts/${glsVerificationArtifactId}` as const }
...
*/
export function locationInterestView(customerId: string | number, campaignId: string | number, adGroupId: string | number, criterionId: string | number): LocationInterestViewResourceName { return `customers/${customerId}/locationInterestViews/${campaignId}~${adGroupId}~${criterionId}` as const }
...
*/
export function locationView(customerId: string | number, campaignId: string | number, criterionId: string | number): LocationViewResourceName { return `customers/${customerId}/locationViews/${campaignId}~${criterionId}` as const }
...
*/
export function managedPlacementView(customerId: string | number, adGroupId: string | number, criterionId: string | number): ManagedPlacementViewResourceName { return `customers/${customerId}/managedPlacementViews/${adGroupId}~${criterionId}` as const }
...
*/
export function matchedLocationInterestView(customerId: string | number, countryCriterionId: string | number): MatchedLocationInterestViewResourceName { return `customers/${customerId}/matchedLocationInterestViews/${countryCriterionId}` as const }
...
*/
export function mediaFile(customerId: string | number, mediaFileId: string | number): MediaFileResourceName { return `customers/${customerId}/mediaFiles/${mediaFileId}` as const }
...
*/
export function mobileAppCategoryConstant(mobileAppCategoryId: string | number): MobileAppCategoryConstantResourceName { return `mobileAppCategoryConstants/${mobileAppCategoryId}` as const }
...
*/
export function mobileDeviceConstant(criterionId: string | number): MobileDeviceConstantResourceName { return `mobileDeviceConstants/${criterionId}` as const }
...
*/
export function multiPartyAuthReview(customerId: string | number, customerInvitationId: string | number): MultiPartyAuthReviewResourceName { return `customers/${customerId}/multiPartyAuthReviews/${customerInvitationId}` as const }
...
*/
export function offlineConversionUploadClientSummary(customerId: string | number, client: string | number): OfflineConversionUploadClientSummaryResourceName { return `customers/${customerId}/offlineConversionUploadClientSummaries/${client}` as const }
...
*/
export function offlineConversionUploadConversionActionSummary(customerId: string | number, conversionTypeId: string | number, client: string | number): OfflineConversionUploadConversionActionSummaryResourceName { return `customers/${customerId}/offlineConversionUploadConversionActionSummaries/${conversionTypeId}~${client}` as const }
...
*/
export function offlineUserDataJob(customerId: string | number, offlineUserDataUpdateId: string | number): OfflineUserDataJobResourceName { return `customers/${customerId}/offlineUserDataJobs/${offlineUserDataUpdateId}` as const }
...
*/
export function operatingSystemVersionConstant(criterionId: string | number): OperatingSystemVersionConstantResourceName { return `operatingSystemVersionConstants/${criterionId}` as const }
...
*/
export function paidOrganicSearchTermView(customerId: string | number, campaignId: string | number, adGroupId: string | number, base64SearchTerm: string | number): PaidOrganicSearchTermViewResourceName { return `customers/${customerId}/paidOrganicSearchTermViews/${campaignId}~${adGroupId}~${base64SearchTerm}` as const }
...
*/
export function parentalStatusView(customerId: string | number, adGroupId: string | number, criterionId: string | number): ParentalStatusViewResourceName { return `customers/${customerId}/parentalStatusViews/${adGroupId}~${criterionId}` as const }
...
*/
export function paymentsAccount(customerId: string | number, paymentsAccountId: string | number): PaymentsAccountResourceName { return `customers/${customerId}/paymentsAccounts/${paymentsAccountId}` as const }
...
*/
export function perStoreView(customerId: string | number, placeId: string | number): PerStoreViewResourceName { return `customers/${customerId}/perStoreViews/${placeId}` as const }
...
*/
export function performanceMaxPlacementView(customerId: string | number, base_64Placement: string | number): PerformanceMaxPlacementViewResourceName { return `customers/${customerId}/performanceMaxPlacementViews/${base_64Placement}` as const }
...
*/
export function productCategoryConstant(level: string | number, categoryId: string | number): ProductCategoryConstantResourceName { return `productCategoryConstants/${level}~${categoryId}` as const }
...
*/
export function productGroupView(customerId: string | number, adgroupId: string | number, criterionId: string | number): ProductGroupViewResourceName { return `customers/${customerId}/productGroupViews/${adgroupId}~${criterionId}` as const }
...
*/
export function productLink(customerId: string | number, productLinkId: string | number): ProductLinkResourceName { return `customers/${customerId}/productLinks/${productLinkId}` as const }
...
*/
export function productLinkInvitation(customerId: string | number, customerInvitationId: string | number): ProductLinkInvitationResourceName { return `customers/${customerId}/productLinkInvitations/${customerInvitationId}` as const }
...
*/
export function qualifyingQuestion(qualifyingQuestionId: string | number): QualifyingQuestionResourceName { return `qualifyingQuestions/${qualifyingQuestionId}` as const }
...
*/
export function recommendation(customerId: string | number, recommendationId: string | number): RecommendationResourceName { return `customers/${customerId}/recommendations/${recommendationId}` as const }
...
*/
export function recommendationSubscription(customerId: string | number, recommendationType: string | number): RecommendationSubscriptionResourceName { return `customers/${customerId}/recommendationSubscriptions/${recommendationType}` as const }
...
*/
export function remarketingAction(customerId: string | number, remarketingActionId: string | number): RemarketingActionResourceName { return `customers/${customerId}/remarketingActions/${remarketingActionId}` as const }
...
*/
export function searchTermView(customerId: string | number, campaignId: string | number, adGroupId: string | number, query: string | number): SearchTermViewResourceName { return `customers/${customerId}/searchTermViews/${campaignId}~${adGroupId}~${query}` as const }
...
*/
export function sharedCriterion(customerId: string | number, sharedSetId: string | number, criterionId: string | number): SharedCriterionResourceName { return `customers/${customerId}/sharedCriteria/${sharedSetId}~${criterionId}` as const }
...
*/
export function sharedSet(customerId: string | number, sharedSetId: string | number): SharedSetResourceName { return `customers/${customerId}/sharedSets/${sharedSetId}` as const }
...
*/
export function shoppingPerformanceView(customerId: string | number): ShoppingPerformanceViewResourceName { return `customers/${customerId}/shoppingPerformanceView` as const }
...
*/
export function shoppingProduct(customerId: string | number, merchantCenterId: string | number, channel: string | number, languageCode: string | number, feedLabel: string | number, itemId: string | number): ShoppingProductResourceName { return `customers/${customerId}/shoppingProducts/${merchantCenterId}~${channel}~${languageCode}~${feedLabel}~${itemId}` as const }
...
*/
export function smartCampaignSearchTermView(customerId: string | number, campaignId: string | number, query: string | number): SmartCampaignSearchTermViewResourceName { return `customers/${customerId}/smartCampaignSearchTermViews/${campaignId}~${query}` as const }
...
*/
export function smartCampaignSetting(customerId: string | number, campaignId: string | number): SmartCampaignSettingResourceName { return `customers/${customerId}/smartCampaignSettings/${campaignId}` as const }
...
*/
export function targetingExpansionView(customerId: string | number, campaignId: string | number, targetingExpansionType: string | number): TargetingExpansionViewResourceName { return `customers/${customerId}/targetingExpansionViews/${campaignId}~${targetingExpansionType}` as const }
...
*/
export function thirdPartyAppAnalyticsLink(customerId: string | number, customerLinkId: string | number): ThirdPartyAppAnalyticsLinkResourceName { return `customers/${customerId}/thirdPartyAppAnalyticsLinks/${customerLinkId}` as const }
...
*/
export function topicConstant(topicId: string | number): TopicConstantResourceName { return `topicConstants/${topicId}` as const }
...
*/
export function topicView(customerId: string | number, adGroupId: string | number, criterionId: string | number): TopicViewResourceName { return `customers/${customerId}/topicViews/${adGroupId}~${criterionId}` as const }
...
*/
export function travelActivityGroupView(customerId: string | number, adGroupId: string | number, criterionId: string | number): TravelActivityGroupViewResourceName { return `customers/${customerId}/travelActivityGroupViews/${adGroupId}~${criterionId}` as const }
...
*/
export function travelActivityPerformanceView(customerId: string | number): TravelActivityPerformanceViewResourceName { return `customers/${customerId}/travelActivityPerformanceViews` as const }
...
*/
export function userInterest(customerId: string | number, userInterestId: string | number): UserInterestResourceName { return `customers/${customerId}/userInterests/${userInterestId}` as const }
...
*/
export function userList(customerId: string | number, userListId: string | number): UserListResourceName { return `customers/${customerId}/userLists/${userListId}` as const }
...
*/
export function userListCustomerType(customerId: string | number, userListId: string | number, semanticLabel: string | number): UserListCustomerTypeResourceName { return `customers/${customerId}/userListCustomerTypes/${userListId}~${semanticLabel}` as const }
...
*/
export function userLocationView(customerId: string | number, countryCriterionId: string | number, isTargetingLocation: string | number): UserLocationViewResourceName { return `customers/${customerId}/userLocationViews/${countryCriterionId}~${isTargetingLocation}` as const }
...
*/
export function video(customerId: string | number, videoId: string | number): VideoResourceName { return `customers/${customerId}/videos/${videoId}` as const }
...
*/
export function videoEnhancement(customerId: string | number, videoEnhancement: string | number): VideoEnhancementResourceName { return `customers/${customerId}/videoEnhancements/${videoEnhancement}` as const }
...
*/
export function webpageView(customerId: string | number, adGroupId: string | number, criterionId: string | number): WebpageViewResourceName { return `customers/${customerId}/webpageViews/${adGroupId}~${criterionId}` as const }
...
*/
export function youTubeVideoUpload(customerId: string | number, videoUploadId: string | number): YouTubeVideoUploadResourceName { return `customers/${customerId}/youTubeVideoUploads/${videoUploadId}` as const }
