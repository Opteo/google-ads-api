...
*/
export function adGroupExtensionSetting(customerId: string | number, adGroupId: string | number, extensionType: string | number): AdGroupExtensionSettingResourceName { return `customers/${customerId}/adGroupExtensionSettings/${adGroupId}~${extensionType}` as const }
...
*/
export function adGroupFeed(customerId: string | number, adGroupId: string | number, feedId: string | number): AdGroupFeedResourceName { return `customers/${customerId}/adGroupFeeds/${adGroupId}~${feedId}` as const }
...
*/
export function campaignExtensionSetting(customerId: string | number, campaignId: string | number, extensionType: string | number): CampaignExtensionSettingResourceName { return `customers/${customerId}/campaignExtensionSettings/${campaignId}~${extensionType}` as const }
...
*/
export function campaignFeed(customerId: string | number, campaignId: string | number, feedId: string | number): CampaignFeedResourceName { return `customers/${customerId}/campaignFeeds/${campaignId}~${feedId}` as const }
...
*/
export function customerExtensionSetting(customerId: string | number, extensionType: string | number): CustomerExtensionSettingResourceName { return `customers/${customerId}/customerExtensionSettings/${extensionType}` as const }
...
*/
export function customerFeed(customerId: string | number, feedId: string | number): CustomerFeedResourceName { return `customers/${customerId}/customerFeeds/${feedId}` as const }
...
*/
export function extensionFeedItem(customerId: string | number, feedItemId: string | number): ExtensionFeedItemResourceName { return `customers/${customerId}/extensionFeedItems/${feedItemId}` as const }
...
*/
export function feed(customerId: string | number, feedId: string | number): FeedResourceName { return `customers/${customerId}/feeds/${feedId}` as const }
...
*/
export function feedItem(customerId: string | number, feedId: string | number, feedItemId: string | number): FeedItemResourceName { return `customers/${customerId}/feedItems/${feedId}~${feedItemId}` as const }
...
*/
export function feedItemSet(customerId: string | number, feedId: string | number, feedItemSetId: string | number): FeedItemSetResourceName { return `customers/${customerId}/feedItemSets/${feedId}~${feedItemSetId}` as const }
...
*/
export function feedItemSetLink(customerId: string | number, feedId: string | number, feedItemSetId: string | number, feedItemId: string | number): FeedItemSetLinkResourceName { return `customers/${customerId}/feedItemSetLinks/${feedId}~${feedItemSetId}~${feedItemId}` as const }
...
*/
export function feedItemTarget(customerId: string | number, feedId: string | number, feedItemId: string | number, feedItemTargetType: string | number, feedItemTargetId: string | number): FeedItemTargetResourceName { return `customers/${customerId}/feedItemTargets/${feedId}~${feedItemId}~${feedItemTargetType}~${feedItemTargetId}` as const }
...
*/
export function feedMapping(customerId: string | number, feedId: string | number, feedMappingId: string | number): FeedMappingResourceName { return `customers/${customerId}/feedMappings/${feedId}~${feedMappingId}` as const }
...
*/
export function feedPlaceholderView(customerId: string | number, placeholderType: string | number): FeedPlaceholderViewResourceName { return `customers/${customerId}/feedPlaceholderViews/${placeholderType}` as const }
...
*/
export function merchantCenterLink(customerId: string | number, merchantCenterId: string | number): MerchantCenterLinkResourceName { return `customers/${customerId}/merchantCenterLinks/${merchantCenterId}` as const }
...
*/
export function productBiddingCategoryConstant(countryCode: string | number, level: string | number, id: string | number): ProductBiddingCategoryConstantResourceName { return `productBiddingCategoryConstants/${countryCode}~${level}~${id}` as const }
