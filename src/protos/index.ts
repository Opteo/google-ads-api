...
export const VERSION = googleAdsVersion as "v8";

// -- Expose the googleads generated types --

// The namespace path is shortened for ease of use
export import common = protos.google.ads.googleads.v8.common;
export import errors = protos.google.ads.googleads.v8.errors;
export import resources = protos.google.ads.googleads.v8.resources;
export import services = protos.google.ads.googleads.v8.services;

// We compile enums ourselves, the Google ones should be used internally only
export import internalEnums = protos.google.ads.googleads.v8.enums;
