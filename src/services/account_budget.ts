...
const account_budget = {
    ...
    total_adjustments_micros: 'int64', // The total adjustments amount.  An example of an adjustment is courtesy credits.
    pending_proposal: {
        ...
        spending_limit_micros: 'int64', // The spending limit in micros.  One million is equivalent to one unit.
        notes: 'string', // Notes associated with this budget.
        name: 'string', // The name to assign to the account-level budget.
    },
    approved_spending_limit_micros: 'int64', // The approved spending limit in micros.  One million is equivalent to one unit.  This will only be populated if the proposed spending limit is finite, and will always be greater than or equal to the proposed spending limit.
    ...
    id: 'int64', // The ID of the account-level budget.
    ...
    amount_served_micros: 'int64', // The value of Ads that have been served, in micros.  This includes overdelivery costs, in which case a credit might be automatically applied to the budget (see total_adjustments_micros).
    purchase_order_number: 'string', // A purchase order number is a value that helps users reference this budget in their monthly invoices.
