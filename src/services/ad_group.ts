...
const ad_group = {
    effective_target_roas: 'double', // The effective target ROAS (return-on-ad-spend). This field is read-only.
    type:
    ...
    percent_cpc_bid_micros: 'int64', // The percent cpc bid amount, expressed as a fraction of the advertised price for some good or service. The valid range for the fraction is [0,1) and the value stored here is 1,000,000 * [fraction].
    targeting_setting: {
        target_restrictions: 'array', // The per-targeting-dimension setting to restrict the reach of your campaign or ad group.
    },
    cpc_bid_micros: 'int64', // The maximum CPC (cost-per-click) bid.
    ...
    target_cpa_micros: 'int64', // The target CPA (cost-per-acquisition).
    explorer_auto_optimizer_setting: {
        opt_in: 'boolean', // Indicates whether the optimizer is turned on.
    },
    effective_target_cpa_micros: 'int64', // The effective target CPA (cost-per-acquisition). This field is read-only.
    ...
    cpm_bid_micros: 'int64', // The maximum CPM (cost-per-thousand viewable impressions) bid.
    id: 'int64', // The ID of the ad group.
    ...
    target_roas: 'double', // The target ROAS (return-on-ad-spend) override. If the ad group's campaign bidding strategy is a standard Target ROAS strategy, then this field overrides the target ROAS specified in the campaign's bidding strategy. Otherwise, this value is ignored.
    target_cpm_micros: 'int64', // Average amount in micros that the advertiser is willing to pay for every thousand times the ad is shown.
}
