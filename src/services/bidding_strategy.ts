...
const bidding_strategy = {
    ...
    campaign_count: 'string', // The number of campaigns attached to this bidding strategy.  This field is read-only.
    ...
    page_one_promoted: {
        ...
        bid_modifier: 'number', // Bid multiplier to be applied to the relevant bid estimate (depending on the `strategy_goal`) in determining a keyword's new CPC bid.
    ...
    id: 'string', // The ID of the bidding strategy.
    non_removed_campaign_count: 'string', // The number of non-removed campaigns attached to this bidding strategy.  This field is read-only.
