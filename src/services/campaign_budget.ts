...
const campaign_budget = {
    amount_micros: 'string', // The amount of the budget, in the local currency for the account. Amount is specified in micros, where one million is equivalent to one currency unit.
    ...
    reference_count: 'string', // The number of campaigns actively using the budget.  This field is read-only.
    recommended_budget_amount_micros: 'string', // The recommended budget amount. If no recommendation is available, this will be set to the budget amount. Amount is specified in micros, where one million is equivalent to one currency unit.  This field is read-only.
    ...
    id: 'string', // The ID of the campaign budget.  A campaign budget is created using the CampaignBudgetService create operation and is assigned a budget ID. A budget ID can be shared across different campaigns; the system will then allocate the campaign budget among different campaigns to get optimum results.
    ...
    recommended_budget_estimated_change_weekly_views: 'string', // The estimated change in weekly views if the recommended budget is applied.  This field is read-only.
    recommended_budget_estimated_change_weekly_interactions: 'string', // The estimated change in weekly interactions if the recommended budget is applied.  This field is read-only.
    ...
    total_amount_micros: 'string', // The lifetime amount of the budget, in the local currency for the account. Amount is specified in micros, where one million is equivalent to one currency unit.
    recommended_budget_estimated_change_weekly_clicks: 'string', // The estimated change in weekly clicks if the recommended budget is applied.  This field is read-only.
    type: 'UNSPECIFIED | UNKNOWN | STANDARD | HOTEL_ADS_COMMISSION', // The type of the campaign budget.
    recommended_budget_estimated_change_weekly_cost_micros: 'string', // The estimated change in weekly cost in micros if the recommended budget is applied. One million is equivalent to one currency unit.  This field is read-only.
}
