...
const conversion_action = {
    ...
    click_through_lookback_window_days: 'int64', // The maximum number of days that may elapse between an interaction (e.g., a click) and a conversion event.
    ...
    view_through_lookback_window_days: 'int64', // The maximum number of days which may elapse between an impression and a conversion without an interaction.
    ...
    phone_call_duration_seconds: 'int64', // The phone call duration in seconds after which a conversion should be reported for this conversion action.  The value must be between 0 and 10000, inclusive.
    ...
    id: 'int64', // The ID of the conversion action.
    value_settings: {
        default_value: 'double', // The value to use when conversion events for this conversion action are sent with an invalid, disallowed or missing value, or when this conversion action is configured to always use the default value.
