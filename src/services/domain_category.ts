...
const domain_category = {
    coverage_fraction: 'number', // Fraction of pages on your site that this category matches.
    ...
    recommended_cpc_bid_micros: 'string', // The recommended cost per click for the category.
    ...
    category_rank: 'string', // The position of this category in the set of categories. Lower numbers indicate a better match for the domain. null indicates not recommended.
}
