...
const keyword_plan_keyword = {
    ...
    cpc_bid_micros: 'string', // A keyword level max cpc bid in micros, in the account currency, that overrides the keyword plan ad group cpc bid.
    keyword_plan_ad_group: 'string', // The Keyword Plan ad group to which this keyword belongs.
    text: 'string', // The keyword text.
    id: 'string', // The ID of the Keyword Plan keyword.
}
